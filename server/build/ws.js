...
export function connection(ws, req) {
    ...
    ws.on("message", (data, isBinary) => {
        ...
        // AUTHENTIACETED SENDS MESSAGE
            ...
            try {
                var newEntrie = JSON.parse(stringified);
...
function addData(table, value, isArray = false) {
...
function addToSendOut(table, value) {
